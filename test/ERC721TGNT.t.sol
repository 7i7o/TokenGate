...
ERC721TGNTTester private nftTester;
    ...
    function setUp() public {
        nftTester = new ERC721TGNTTester();
    }
    ...
    /** @dev Test minting and burning an NFT from team (to another address) */
    function testTeamBurn() public {
        console2.log("Mint a token from team. To msg.sender address: ", msg.sender);
        nftTester.teamMint(msg.sender);
        console2.log("Burn a token from team. Burning msg.sender tokenId: ", msg.sender);
        nftTester.teamBurn(uint256(uint160(msg.sender)));
        assertTrue(nftTester.balanceOf(msg.sender) == 0);
    }
    ...
    function testExpectRevertOnDoubleMint() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC721TGNT.AlreadyOwnsToken.selector, address(this)));
        nftTester.safeMint();
    }
    ...
    function testExpectRevertNonExistentToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC721TGNT.NonExistentTokenId.selector,uint256(uint160(address(this)))));
    ...
    function testExpectRevertAddressZero() public {
        ...
        vm.expectRevert(ERC721TGNT.ZeroAddressQuery.selector);
    ...
    function testExpectRevertApproval() public {
        ...
        vm.expectRevert(ERC721TGNT.TransferAndApprovalsDisabled.selector);
